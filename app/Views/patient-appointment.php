                        ...
                        <div class="card mb-0">
                            <div class="card-body doctor-info">
                                ...
                                <div class="text-center mb-5">
                                    ...
                                    <span class="font-size-14">Dokter Spesialis Kandungan</span>
                                </div>

                                <span class="text-uppercase font-medium d-block mb-3 d-flex justify-content-center align-items-center gap-2"><i class="mdi mdi-google-maps"></i> RSD Kalisat Jember</span>
                    ...
                    <div class="order-1 order-md-2 col-md-7 col-lg-8">
                        <div class="card h-100">
                            <div class="card-header mb-3">
                                <span class="font-medium d-block mb-2">Pilih Jadwal</span>
                                <span>Jadwal dr. Teguh Santoso, Sp. OG. untuk tanggal 15-12-2022</span>
                            </div>
                            <div class="card-body">
